...
function App() {
  ...
  const handleFlashcards = async () => {
    ...
    flashcardRef.current.scrollIntoView({ behavior: 'smooth' }); // Scroll to Flashcards section
  };
  ...
  const handleRecommendations = async () => {
    ...
    recommendationRef.current.scrollIntoView({ behavior: 'smooth' }); // Scroll to Recommendations section
  };
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* Flashcards Section */}
      <div ref={flashcardRef} className="mt-6">
        {flashcards && (
          <>
      ...
      <div ref={recommendationRef} className="mt-6">
        {recommendations && (
          <>
